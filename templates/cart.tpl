                        ...
                        <?php if (!empty($products)) : $p = 1; ?>
                            <?php foreach ($products as $product) : ?>
                                <tr>
                                    ...
                                    <td class="name"><a href="product.php?product_id=<?= $product['product_id'] ?>" title="<?= $product['name'] ?>"><?= $product['name'] ?></a>
                                    </td>
                                    <td class="image">
                                    ...
                                    <td class="action"><a class="btn remove" href="cart.php?removeFromCart=1&product_id=<?= $product['product_id'] ?>" title="Удалить">Удалить</a></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
                            <tr>
